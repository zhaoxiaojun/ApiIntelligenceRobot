...
import com.vip.yyl.domain.*;
import com.vip.yyl.repository.*;
import com.vip.yyl.service.dto.*;
import com.vip.yyl.service.enums.NodeType;
import com.vip.yyl.service.handler.AssertHandler;
import com.vip.yyl.service.handler.http.GenericHandler;
import com.vip.yyl.web.rest.util.DTOToEntity;
import com.vip.yyl.web.rest.util.EntityToDTO;
import com.vip.yyl.web.rest.util.HeaderUtil;
...
//        }
//        String url = browserClientRequestUrl.setState("com/vip/yyl/restfiddle").setScopes(scopes).setRedirectUri("http://localhost:8080/oauth/response").build();
//
...
//            "82089573969-nocs1ulh96n5kfut1bh5cq7n1enlfoe8.apps.googleusercontent.com").setState("com/vip/yyl/restfiddle").setScopes(scopes)
