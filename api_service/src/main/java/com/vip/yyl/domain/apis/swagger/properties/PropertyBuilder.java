package com.vip.yyl.domain.apis.swagger.properties;

import com.vip.yyl.domain.apis.swagger.ArrayModel;
import com.vip.yyl.domain.apis.swagger.Model;
import com.vip.yyl.domain.apis.swagger.ModelImpl;
import com.vip.yyl.domain.apis.swagger.RefModel;
...
public class PropertyBuilder {
    ...
    private enum Processor {
        ...
        BYTE_ARRAY(com.vip.yyl.domain.apis.swagger.properties.ByteArrayProperty.class) {
            @Override
            protected boolean isType(String type, String format) {
                return com.vip.yyl.domain.apis.swagger.properties.ByteArrayProperty.isType(type, format);
            }

            @Override
            protected com.vip.yyl.domain.apis.swagger.properties.ByteArrayProperty create() {
                return new com.vip.yyl.domain.apis.swagger.properties.ByteArrayProperty();
            }
        },
        ...
        DATE_TIME(com.vip.yyl.domain.apis.swagger.properties.DateTimeProperty.class) {
            @Override
            protected boolean isType(String type, String format) {
                return com.vip.yyl.domain.apis.swagger.properties.DateTimeProperty.isType(type, format);
            }

            @Override
            protected com.vip.yyl.domain.apis.swagger.properties.DateTimeProperty create() {
                return new com.vip.yyl.domain.apis.swagger.properties.DateTimeProperty();
            }
        },
        ...
        INTEGER(com.vip.yyl.domain.apis.swagger.properties.BaseIntegerProperty.class) {
            @Override
            protected boolean isType(String type, String format) {
                return com.vip.yyl.domain.apis.swagger.properties.BaseIntegerProperty.isType(type, format);
            }

            @Override
            protected com.vip.yyl.domain.apis.swagger.properties.BaseIntegerProperty create() {
                return new com.vip.yyl.domain.apis.swagger.properties.BaseIntegerProperty();
            }

            @Override
            public Property merge(Property property, Map<PropertyId, Object> args) {
                super.merge(property, args);
                if (property instanceof com.vip.yyl.domain.apis.swagger.properties.BaseIntegerProperty) {
                    final com.vip.yyl.domain.apis.swagger.properties.BaseIntegerProperty resolved = (com.vip.yyl.domain.apis.swagger.properties.BaseIntegerProperty) property;
                    mergeNumeric(resolved, args);
                }
                return property;
            }
        ...
        protected <N extends com.vip.yyl.domain.apis.swagger.properties.AbstractNumericProperty> N mergeNumeric(N property, Map<PropertyId, Object> args) {
        ...
        public Property merge(Property property, Map<PropertyId, Object> args) {
            ...
            if (property instanceof com.vip.yyl.domain.apis.swagger.properties.AbstractProperty) {
                final com.vip.yyl.domain.apis.swagger.properties.AbstractProperty resolved = (com.vip.yyl.domain.apis.swagger.properties.AbstractProperty) property;
                ...
                if(args.containsKey(PropertyId.ENUM)) {
                    ...
                    if(values != null) {
                       ...
                       if(property instanceof com.vip.yyl.domain.apis.swagger.properties.DateTimeProperty) {
                         com.vip.yyl.domain.apis.swagger.properties.DateTimeProperty p = (com.vip.yyl.domain.apis.swagger.properties.DateTimeProperty) property;
                         for(String value : values) {
                           try {
                             p._enum(value);
                           }
